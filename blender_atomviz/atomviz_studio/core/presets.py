...
_LOOK_LIST: tuple[Look, ...] = (
    Look(
        ...
        postfx={"glare": "FOG_GLOW", "glare_threshold": 1.1, "vignette": 0.0},
    ...
    Look(
        ...
        style_params={"roughness": 0.18, "emissive_dopants": 6.0},
        ...
        volumetrics=0.012,
        electricity={"count": 6, "chaos": 0.18, "thickness": 0.035, "color": "#7dd3fc",
                     "strength": 40.0, "branches": 2, "flicker": True},
        postfx={"glare": "FOG_GLOW", "glare_threshold": 0.55, "streaks": True,
                "vignette": 0.35},
    ...
    Look(
        ...
        accent="#f97316",
        style="glossy_ceramic",
        style_params={"roughness": 0.22, "emissive_dopants": 9.0},
        stick_style="polished_metal",
        stick_color="#334155",
        background="plasma",
        ...
        volumetrics=0.02,
        electricity={"count": 14, "chaos": 0.24, "thickness": 0.03, "color": "#c084fc",
                     "strength": 60.0, "branches": 3, "cage": True, "flicker": True},
        postfx={"glare": "FOG_GLOW", "glare_threshold": 0.4, "streaks": True,
                "vignette": 0.45},
    ...
    Look(
        ...
        lighting="neon_rim",
        lighting_params={"color_a": "#ef4444", "color_b": "#3b82f6", "energy": 400.0},
        volumetrics=0.035,
        lasers={"count": 3, "radius": 0.05, "color": "#ff2d2d", "strength": 90.0,
                "impact": True, "haze": True},
        postfx={"glare": "STREAKS", "glare_threshold": 0.5, "vignette": 0.5},
    ...
    Look(
        ...
        stick_color="#5a4a2f",
        background="gradient",
        background_params={"top": "#120c05", "bottom": "#3a2410", "accent": "#a97b26"},
        lighting="three_point",
        lighting_params={"energy": 1100.0, "warm": "#ffd9a0", "cool": "#9ec5ff"},
        volumetrics=0.008,
        postfx={"glare": "FOG_GLOW", "glare_threshold": 0.8, "vignette": 0.35},
    ...
    Look(
        ...
        accent="#7dd3fc",
        style="xray_fresnel",
        style_params={"emission_strength": 3.0, "alpha": 0.25},
        ...
        postfx={"glare": "FOG_GLOW", "glare_threshold": 0.5, "vignette": 0.4},
    ...
    Look(
        ...
        accent="#5eead4",
        style="hologram",
        style_params={"emission_strength": 5.0, "scanlines": 90.0, "alpha": 0.45},
        stick_style="emissive_neon",
        stick_color="#5eead4",
        ...
        electricity={"count": 4, "chaos": 0.12, "thickness": 0.02, "color": "#5eead4",
                     "strength": 30.0, "branches": 1, "flicker": True},
        postfx={"glare": "FOG_GLOW", "glare_threshold": 0.35, "streaks": True,
                "vignette": 0.4},
